...
/*This is a sample implementation of Prototype method. 
We have the detailed description of all the components here.
...
RecordFactory class that has a Factory method CreateRecord(…). 
This method requires an enum RecordType as parameter and depending on this parameter 
it returns the concrete implementation of Record class.*/
